# import asyncio
#
# async def print_every_second(delay):
#     for i in range(1, 11):  # Выводим сообщение 10 раз с интервалом в 1 секунду
#         print(f"{'=' * i} Second {i} {'=' * i}")
#         await asyncio.sleep(delay)
#
# async def main():
#     await print_every_second(1)  # Запускаем функцию с интервалом в 1 секунду
#
# asyncio.run(main())
